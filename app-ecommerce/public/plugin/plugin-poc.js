         ...
         if(find_url.length>0){
            ...
            if($("#iaframeStream").length === 0) {
               ...
               $(document).on('click', '#iabotBtn', function() {
                  ...
                  $('#iaframeStreamLoader').toggleClass('open');
