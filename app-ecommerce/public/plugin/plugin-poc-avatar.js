...
try {
   const URLs = [
      ...
      {
         url: 'http://127.0.0.1:5501/app-ecommerce/public/ejemplo-avatar.html',
         parametro: 'redecilla-de-pelo'
      }
   ];
      ...
      setInterval(function() {
         ...
         if(find_url.length>0){
            ...
            if($("#iawindow").length === 0) {
               ...
               const linkStyle = `<link rel="stylesheet" href="./plugin/styles-avatar.css" />`;
               ...
               $(document.body).append(`<div id="iabot" class="iabot">
                                          ...
                                          <button type="button" id="iabotBtn" class="iabot-btn">
                                             <div class="iabot-avatar">
                                                <img src="https://res.cloudinary.com/dbfsnew4w/image/upload/v1727726873/avatar-women_zmdj3n.png" /> 
                                             </div>
